...
public class BastionRemnantsFMC {
    ...
    public BastionRemnantsFMC(World worldIn, TemplateManager template, List<StructureComponent> components) {
        this.world = worldIn;
    ...
    public void startBastion(BlockPos pos, Rotation rot) {
        ...
        BastionTemplate pig_fort = new BastionTemplate(manager, "fmc/pig_fort/pig_bridge", pos, rot, 0, true);

        BastionTemplate stable_fort = new BastionTemplate(manager, "fmc/pig_fort/tower_l_1", pos, rot, 0, true);
    ...
    private boolean finishFort(BastionTemplate parent, BlockPos pos, Rotation rot) {
        BastionTemplate right_tower = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-16, 0, 16), "fmc/pig_fort/tower_r_1", rot);
        BastionTemplate lower_part_left = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-16, -24, 0), "fmc/pig_fort/big_pillar_l_2", rot);
        BastionTemplate lower_part_right = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-16, -24, 16), "fmc/pig_fort/big_pillar_r_2", rot);
        //start House unit 1
        BastionTemplate unit_1 = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0,-14,4), "fmc/units/house_unit_1", rot);
        BastionTemplate unit_2 =addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(8, -14, 4), "fmc/units/house_unit_2", rot);
        BastionTemplate unit_3 = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(16, -14, 4), "fmc/units/house_unit_3", rot);
    ...
    private boolean generatePigFort(BastionTemplate parent, BlockPos pos, Rotation rot) {
        BastionTemplate pig_face = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0, 8,0), "fmc/pig_fort/pig_face", rot);
        BastionTemplate left_pillar = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0,-16,-8), "fmc/pig_fort/big_pillar_l_1", rot);
        BastionTemplate right_pillar = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0, -16, 8), "fmc/pig_fort/big_pillar_r_1", rot);
        BastionTemplate front_face = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-5,17,1 ), "fmc/pig_fort/front_face", rot);
        BastionTemplate pillar_for_bridge = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-12, -16,0), "fmc/bridge_parts/pillar_1", rot);
    ...
    private boolean generateSideTowers(BastionTemplate parent, BlockPos pos, Rotation rot) {
        BastionTemplate side_tower_left = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-16, -24, -24), "fmc/pig_fort/big_pillar_l_2", rot);
        BastionTemplate side_tower_right = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-16, -24, 24), "fmc/pig_fort/big_pillar_r_2", rot);
        BastionTemplate tower_left = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-16, 0, -24), "fmc/pig_fort/tower_l_1", rot);
        BastionTemplate tower_right = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(-16, 0, 24), "fmc/pig_fort/tower_r_1", rot);
    ...
    private boolean generateBridgeTooHold(BastionTemplate parent, BlockPos pos, Rotation rot) {
        BastionTemplate bridge = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0,1,0), "fmc/bridge_parts/bridge_to_hold_1", rot);
    ...
    private boolean startHoldEntrance(BastionTemplate parent, BlockPos pos, Rotation rot) {
        ...
        BastionTemplate entrance_b_l = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0,-2,10),"fmc/hold/top_r_layer_entrance", rot);
        BastionTemplate entrance_t_l = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0,-2,-10), "fmc/hold/bot_r_layer_entrance", rot);
        //Outer two pieces
        BastionTemplate entrance_t_r = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(20, -2, 10), "fmc/hold/top_l_layer_entrance", rot);
        BastionTemplate entrance_b_r = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(20, -2, -10), "fmc/hold/bot_l_layer_entrance", rot);
    ...
    private boolean generateBastionGenerateUpperLayer(BastionTemplate parent, BlockPos pos, Rotation rot) {
        String[] top_right_types = {"fmc/hold/top_r_layer_1", "fmc/hold/top_r_layer_2", "fmc/hold/top_r_layer_3", "fmc/hold/top_r_layer_4", "fmc/hold/top_r_layer_5"};
        BastionTemplate layer_t_r = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(0, 6, 10), ModRand.choice(top_right_types), rot);
        String[] bottom_right_types = {"fmc/hold/bot_r_layer_1", "fmc/hold/bot_r_layer_2", "fmc/hold/bot_r_layer_3", "fmc/hold/bot_r_layer_4", "fmc/hold/bot_r_layer_5"};
        ...
        String[] top_left_types = {"fmc/hold/top_l_layer_1", "fmc/hold/top_l_layer_2", "fmc/hold/top_l_layer_3", "fmc/hold/top_l_layer_4", "fmc/hold/top_l_layer_5"};
        BastionTemplate layer_t_l = addAdjustedPieceNoCount(parent, BlockPos.ORIGIN.add(20, 6, 10), ModRand.choice(top_left_types), rot);
        String[] bottom_left_types = {"fmc/hold/bot_l_layer_1", "fmc/hold/bot_l_layer_2", "fmc/hold/bot_l_layer_3", "fmc/hold/bot_l_layer_4", "fmc/hold/bot_l_layer_5"};
    ...
    private boolean generateInnerBridges(BastionTemplate parent, BlockPos pos, Rotation rot) {
        String[] inner_types = {"fmc/bridge_parts/hold_bridge_1", "fmc/bridge_parts/hold_bridge_2","fmc/bridge_parts/hold_bridge_3","fmc/bridge_parts/hold_bridge_4","fmc/bridge_parts/hold_bridge_5"};
